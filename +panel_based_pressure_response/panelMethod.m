function [resulting_force_B__N, resulting_torque_B__Nm] ...
                        = panelMethod(attitude_quaternion_BI, ...
                                       pressure_I_I__N_per_m2, ...
                                       bodies, ...                                                       
...
%    pressure_I_I__N_per_m2: 3x1 vector of the pressure acting on the body in
%            inertial frame
...
pressure_magnitude__N_per_m2 = norm(pressure_I_I__N_per_m2);
pressure_dir_I = pressure_I_I__N_per_m2/pressure_magnitude__N_per_m2; % make sure its a unit vector
...
pressure_dir_B = smu.unitQuat.att.transformVector(q_BI, pressure_dir_I);

ind_not_shadowed = ~determineShadowedTriangles(vertices_B, centroids_B, normals_B, pressure_dir_B);
